...
//  MVVMBasicStructure
//
//  Created by Hyperlink on 22/09/20.
...
extension UIApplication {
    ...
    func setHome() {
        ...
        if let loginNavigation = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "NavHome") as? UINavigationController {
            self.setRootController(for: loginNavigation)
        }
    }
